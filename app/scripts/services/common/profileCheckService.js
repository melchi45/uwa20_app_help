kindFramework.factory('ProfileCheckService', [
	function() {
		...
		var resolutionArray = ['320x240', '640x360', '640x480', '720x480', '720x576', 			// 0 ~ 4
										  ...
										  '2560x1920', '3840x2160', '4096x2160', '4000x3000'];							// 15 ~ 18
		...
		for (var i = 0; i < resolutionArray.length; i++) {
			...
			for (var j = 0; j < mjpegMaxFrameRate; j++) {
				mjpegAvalidableArray[i][j] = {resolution:resolutionArray[i], frameRate:(j + 1), available:true};
		...
		for (var i = 0; i < resolutionArray.length; i++) {
			...
			for (var j = 0; j < h264MaxFrameRate; j++) {
				h264AvalidableArray[i][j] = {resolution:resolutionArray[i], frameRate:(j + 1), available:true};
		...
		for (var i = 0; i < resolutionArray.length; i++) {
			...
			for (var j = 0; j < h265MaxFrameRate; j++) {
				h265AvalidableArray[i][j] = {resolution:resolutionArray[i], frameRate:(j + 1), available:true};
