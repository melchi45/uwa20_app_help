kindFramework.service('EventNotificationService', ['$rootScope', '$timeout', 'UniversialManagerService', '$interval', 'CAMERA_STATUS', 'sketchbookService',
  function($rootScope, $timeout, UniversialManagerService, $interval, CAMERA_STATUS, sketchbookService) {
    ...
    var fullscreenBorderCSS = "3px solid transparent";
    var detectBorderCSS = "3px solid red";
