...
kindFramework.
  ...
  function($scope, $rootScope, $timeout, MultiLanguage, SunapiClient, Attributes, 
  SessionOfUserManager, EventStatusService) {
    'use strict';
    ...
    function getSupportedLanguages() {
      if (typeof mAttr.Languages === 'undefined') {
        $scope.languages = ["English", "Korean", "Chinese", "French", "Italian", "Spanish", 
          "German", "Japanese", "Russian", "Swedish", "Danish", "Portuguese", "Czech", "Polish", 
          "Turkish", "Romania", "Serbian", "Dutch", "Croatian", "Hungarian", "Greek", "Norsk", 
          "Finnish"];
