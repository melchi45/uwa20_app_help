...
"use strict";
    ...
    function setSliderDisabled(){
        if($scope.MotionDetection.MotionDetectionEnable === false || typeof $scope.isSelectedIncludeIndex === "undefined" || parseInt($scope.isSelectedIncludeIndex) === 0){
                    ...
                    setEnable().then(function(){
                        ...
                        if (returnValue)
                        {
                            if (!angular.equals(pageData.VA[$scope.presetTypeData.SelectedPreset], $scope.VA[$scope.presetTypeData.SelectedPreset]))
                            {
                                ...
                                $q.seqAll(promises).then(function () {
                                    var promises2 = [];
                                    promises2.push(function(){return addUserToHandover(areaIndex + 1, $scope.presetTypeData.SelectedPreset, g_userList);});
                                    $q.seqAll(promises2).then(function () {
                                        var promises3 = [];
                                        if ($scope.presetTypeData.SelectedPreset > 0){
                                ...
                                promises.push(function(){return addUserToHandover(areaIndex + 1, $scope.presetTypeData.SelectedPreset, g_userList);});
                                $q.seqAll(promises).then(function () {
                                    var promises3 = [];
                                    if ($scope.presetTypeData.SelectedPreset > 0){
                                        promises3.push(getPresetHandoverList);
