  ...
  var QueueModel = function () {
    ...
    var lang = {
      ...
      realTime: {
        ...
        rotationMessage: 'lang_pc_hm_data_init_rule',
      },
      graph: {
        today: 'lang_today',
        weekly: 'lang_weekly',
    ...
    (function langInit() {
      lang.graph.cumulative = $translate.instant(lang.graph.cumulative) + '(' + $translate.instant('lang_minute') + ')';
      lang.queueUndefined.disable = $translate.instant('lang_msg_please_enable').replace('%1', $translate.instant(lang.queueManagement));
      lang.queueUndefined.noRule = $translate.instant('lang_msg_noarea') + ' ' + $translate.instant('lang_msg_addarea').replace('%1', $translate.instant('lang_setup'));
