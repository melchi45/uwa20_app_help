...
function BaseLogin(
  ...
  var errorCallBack = function(error) {
    ...
    /*
     *** login ���� �� native���� web���� ���۵Ǵ� ���ڿ�
    -. Timeout���� ���� ���� : "loginResultFailTimeout"
    -. id/password�� �߸��Ǿ��� ��� :  "loginResultFailUnauthorized"
    -. ��Ʈ��ũ�� ������ �ȵǾ��� ��� : "loginResultFailNetworkNotConnected"
    -. �� ���� ������ ���еǾ��� ��� : "loginResultFailOther"
    */
