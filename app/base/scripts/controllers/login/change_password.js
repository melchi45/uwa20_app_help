  ...
  controller('ChangePasswordCtrl', function(
    ...
    function isSafePassword(passwd) {
      ...
      function isValidRule1(passwd) {
        ...
        if (passwd.match(PATTERN_NUM)) {
          acceptCount++;
        }
        if (passwd.match(PATTERN_UPPER_ALPHA)) {
          acceptCount++;
        }
        if (passwd.match(PATTERN_LOWER_ALPHA)) {
          acceptCount++;
        }
        if (passwd.match(PATTERN_SIMBOL4)) {
          acceptCount++;
        }
