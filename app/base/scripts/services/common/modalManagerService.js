...
kindFramework.service('ModalManagerService', ['$uibModal', '$uibModalStack',
  function($uibModal, $uibModalStack) {
    ...
    var modalList = {
      ...
      'alarmout': {
        'controller': 'ModalInstnceAlarmOutCtrl',
        'template': 'views/livePlayback/modal/ModalAlarmout.html',
        'priority': 2
      },
      'b2clogin': {
        'controller': 'ModalInstnceB2CLoginCtrl',
        'template': 'views/livePlayback/modal/ModalB2CLogin.html',
        'backdrop': 'static',
        'priority': 2
      },
      'b2cPreset': {
        'controller': 'ModalInstnceB2CPresetCtrl',
        'template': 'views/livePlayback/modal/ModalB2CPreset.html',
        'priority': 2
      },
      'b2cprofile': {
        'controller': 'ModalInstnceB2CProfileCtrl',
        'template': 'views/livePlayback/modal/ModalB2CProfile.html',
        'priority': 2
      },
      'checkboxlist': {
      ...
      'favorite': {
        'controller': 'ModalInstnceFavoriteCtrl',
        'template': 'views/livePlayback/modal/ModalFavorite.html',
        'priority': 2
      },
      'flipmirror': {
        'controller': 'ModalInstnceFlipMirrorCtrl',
        'template': 'views/livePlayback/modal/ModalFlipMirror.html',
        'priority': 2
      },
      'list': {
      ...
      'mobilePreset': {
        'controller': 'ModalInstnceMobilePresetCtrl',
        'template': 'views/livePlayback/modal/ModalMobilePreset.html',
        'priority': 2
      },
      'OverlapEvent': {
      ...
      'b2bPassword': {
        'controller': 'ModalInstncePasswordSetting',
        'template': 'views/livePlayback/modal/ModalPasswordSetting.html',
        'priority': 2
      },
      'presetadd': {
      ...
      'search': {
        'controller': 'ModalInstnceSearchCtrl',
        'template': 'views/livePlayback/modal/ModalSearch.html',
        'backdrop': 'static',
        'priority': 2
      },
      'slider': {
      ...
      'voicerecord': {
        'controller': 'ModalInstnceVoiceRecCtrl',
        'template': 'views/livePlayback/modal/ModalVoiceRec.html',
        'priority': 2
      },
      'viewMode': {
        'controller': 'ModalInstanceViewModeCtrl',
        'template': 'views/livePlayback/modal/ModalViewMode.html',
        'priority': 2
      },
      'b2bProfileSelect': {
        'controller': 'ModalB2BProfileSelect',
        'template': 'views/livePlayback/modal/ModalB2BProfileSelect.html',
        'priority': 2
      },
      'bookmarkComment': {
        'controller': 'ModalBookmarkCommentCtrl',
        'template': 'views/livePlayback/modal/ModalBookmarkComment.html',
        'priority': 2
      },
      'ptzmode': {
      ...
      'profileSizeAlert': {
        'controller': 'modalInstnceprofileSizeAlertCtrl',
        'template': 'views/livePlayback/modal/ModalProfileSizeAlert.html',
        'priority': 2
      },
      'generalCheckboxList': {
        'controller': 'ModalGeneralCheckBoxListCtrl',
        'template': 'views/livePlayback/modal/ModalGeneralCheckBoxList.html',
        'priority': 2
      },
      'liveList': {
      ...
      'idPassword': {
        'controller': 'ModalInstnceIdPasswordCtrl',
        'template': 'views/livePlayback/modal/ModalIPPassword.html',
        'priority': 2
      },
      'hugeThumbnail': {
        'controller': 'ModalHugeThumbnailCtrl',
        'template': 'views/livePlayback/modal/ModalHugeThumbnail.html',
        'priority': 2
      }
    };
