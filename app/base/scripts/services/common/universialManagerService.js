kindFramework.service('UniversialManagerService', ['CAMERA_STATUS', 'LocalStorageService',
  function(CAMERA_STATUS, LocalStorageService) {
    ...
    this.setStreamingMode = function(_streamingMode) {
      switch (_streamingMode) {
        ...
        case CAMERA_STATUS.STREAMING_MODE.NO_PLUGIN_MODE:
          break;
        default:
          console.log("You set to wrong streaming mode :: " + _streamingMode);
          return;
      }
    ...
    this.setZoomMode = function(_zoomMode) {
      switch (_zoomMode) {
        ...
        case CAMERA_STATUS.ZOOM_MODE.DIGITZL_PTZ:
          break;
        default:
          console.log("You set to wrong zoom mode :: " + _zoomMode);
          return;
      }
    ...
    this.setPlayMode = function(_playMode) {
      switch (_playMode) {
        case CAMERA_STATUS.PLAY_MODE.LIVE:
          break;
        case CAMERA_STATUS.PLAY_MODE.PLAYBACK:
          break;
        default:
          console.log("You set to wrong playmode :: " + _playMode);
          return;
      }
    ...
    this.getServiceType = function() {
      ...
      switch (ServiceType) {
        ...
        case CAMERA_STATUS.WEB_APP_TYPE.IPOLIS_MOBILE:
          break;
        default:
          console.log("wrong ServiceType return :: " + ServiceType);
      }
    ...
    this.setViewMode = function(_viewMode) {
      switch (_viewMode) {
        case CAMERA_STATUS.VIEW_MODE.CHANNEL:
          break;
        case CAMERA_STATUS.VIEW_MODE.FULL:
          break;
        case CAMERA_STATUS.VIEW_MODE.DETAIL:
          break;
        case CAMERA_STATUS.VIEW_MODE.ALLCHANNEL:
          break;
        default:
          console.log("You set to wrong viewmode :: " + _viewMode);
          return;
      }
    ...
    this.setOrientation = function(_orientation) {
      switch (_orientation) {
        case CAMERA_STATUS.ORIENTATION.PORTRAIT:
          break;
        case CAMERA_STATUS.ORIENTATION.LANDSCAPE:
          break;
        default:
          console.log("wrong orientation value :: " + _orientation);
      }
    ...
    this.getOrientation = function() {
      switch (Orientation) {
        ...
        case CAMERA_STATUS.ORIENTATION.LANDSCAPE:
          break;
        default:
          console.log("wrong orientation value :: " + Orientation);
      }
    ...
    this.setRatio = function(_ratio) {
      switch (_ratio) {
        case CAMERA_STATUS.RATIO.ASPECT:
          break;
        case CAMERA_STATUS.RATIO.ORIGINAL:
          break;
        default:
          console.log("wrong ratio value :: " + _ratio);
      }
    ...
    this.getRatio = function() {
      switch (Ratio) {
        ...
        case CAMERA_STATUS.RATIO.ORIGINAL:
          break;
        default:
          console.log("wrong ratio value :: " + Ratio);
      }
      return Ratio;
    };
    ...
    this.setPlayStatus = function(_playstatus) {
      switch (_playstatus) {
        case CAMERA_STATUS.PLAY_STATUS.STOP:
          break;
        case CAMERA_STATUS.PLAY_STATUS.PLAYING:
          break;
        case CAMERA_STATUS.PLAY_STATUS.CONNECTING:
          break;
        default:
          console.log("wrong play status value :: " + _playstatus);
      }
    ...
    this.getPlayStatus = function() {
      switch (PlayStatus) {
        ...
        case CAMERA_STATUS.PLAY_STATUS.CONNECTING:
          break;
        default:
          console.log("wrong play status value :: " + PlayStatus);
      }
      return PlayStatus;
    };
    ...
    this.setLayout = function(_layout) {
      switch (_layout) {
        ...
        case 16:
          break;
        default:
          console.log("wrong layout value :: " + _layout);
      }
      layout = _layout;
    };
    ...
    this.getLayout = function() {
      switch (layout) {
        ...
        case 16:
          break;
        default:
          console.log("wrong layout value :: " + layout);
      }
      return layout;
    };
    ...
    this.setFilp = function(_flipMode) {
      switch (_flipMode) {
        ...
        case 'flip_mirror':
          break;
        default:
          console.log("wrong filp mode value :: " + _flipMode);
      }
    ...
    this.getFilp = function() {
      switch (filpMode) {
        ...
        case 'flip_mirror':
          break;
        default:
          console.log("wrong filp mode value :: " + filpMode);
      }
      return filpMode;
    };
