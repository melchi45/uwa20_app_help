...
kindFramework
  .provider('UniversialManagerService', function() {
    this.$get = ['CAMERA_STATUS', 'LocalStorageService', function(CAMERA_STATUS, LocalStorageService) {
      return new function universialManagerService() {
        var self = this;
        var ProfileInfo;
        var SpeakerVol;
        var MicVol;
