  ...
  return {
    ...
    link: function(scope, element, attrs) {
     ...
     var TOUCH_TIME_INTERVAL = 400;
      ...
      /**
       * ?îå?ü¨Í∑∏Ïù∏?óê?Ñú Full screen ?ã´Í∏∞Î?? ?†ëÍ∑? ?ïòÍ∏? ?úÑ?ï¥ bind?ùÑ ?ï¥Ï§??ã§.
       * @example
      ...
      function resizeHandler(event) {
        ...
        // if(scope.windowSize !== undefined) {
          // if(scope.windowSize > window.innerWidth * window.innerHeight) {
            ...
            /**
             * ?ïÑ?ûò Î∂??Ñ∞?äî Full Screen ?óê?Ñú Detail ViewÎ°? ?ù¥?èô?ï† ?ïå
             * ?ã§?ñâ?êò?äî Î°úÏßÅ?ù¥?ã§.
             */
            event.stopPropagation();

            /**
             * window.onresize ?ãú?óê?äî $digestÍ∞? ?êòÏß? ?ïä?ïÑ
             * scopeÍ∞? view?óê Î∞òÏòÅ?ù¥ ?êòÏß? ?ïä??? ?ù¥?äàÍ∞? ?ûà?ã§.
             * $scope.$apply()?äî ?óê?ü¨Í∞? Î∞úÏÉù?ï† ?àò ?ûà?äî Î¶¨Ïä§?ä∏Í∞? ?ûàÍ∏? ?ïåÎ¨∏Ïóê
             * $timeout?ùÑ ?Üµ?ï¥?Ñú $digestÎ•? ?ïú?ã§.
             */
