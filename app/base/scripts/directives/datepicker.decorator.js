...
angular.module("template/datepicker/day.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/datepicker/day.html",
    ...
    "  <thead>\n" +
    "    <tr>\n" +
    "      <th><button type=\"button\" class=\"btn btn-default btn-sm pull-left\" "+
    ...
    "      <th colspan=\"{{::5 + showWeeks}}\">"+
            "<button id=\"{{::uniqueId}}-title\" role=\"heading\" aria-live=\"assertive\" "+
                    ...
                    "tabindex=\"-1\" style=\"width:100%;\"><strong>{{title}}</strong>"+
            "</button></th>\n" +
    "      <th><button type=\"button\" class=\"btn btn-default btn-sm pull-right\" "+
                      "ng-click=\"move(1)\" tabindex=\"-1\">"+
    ...
    "      <th ng-repeat=\"label in ::labels track by $index\" class=\"text-center\">"+
            "<small aria-label=\"{{::label.full}}\">{{::label.abbr}}</small></th>\n" +
    "    </tr>\n" +
    "  </thead>\n" +
    "  <tbody>\n" +
